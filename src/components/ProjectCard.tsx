...
function ProjectCard({title, description, linkRef, image} : {title: string, description: string, linkRef: string, image: string}) {
  return (
    <div className="max-w-sm bg-white col-span-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a
        href={linkRef}
        target="_blank"
      >
