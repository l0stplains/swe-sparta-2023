...
function Hero() {
  return (
    <div className="w-full h-[100dvh] relative overflow-hidden">
      <img src="/star-bg.jpg" id="star-bg" className="unselectable"></img>
      <div className="relative wrapper flex flex-row max-md:flex-col-reverse justify-between max-md:justify-end items-center h-[85%] p-4">
        <div className="flex justify-start flex-col max-w-[60%] [text-shadow:_6px_6px_12px_#000] text-white">
          ...
          <h1 className="text-4xl font-bold ">
            My name is <span className="text-orange-100">Refki Alfarizi</span>
          </h1>
          <p className="text-lg   mt-4">
            ...
            student in Bandung Institute of Technology. I have strong interest
            in the realm of{" "}
            <span className="text-orange-100 font-semibold">
        ...
        <div className="flip-card min-h-[256px]">
          <div className="absolute scale-125 transition-all rounded-full duration-1000 opacity-50 -inset-px bg-gradient-to-r from-space via-orange-100 to-orange-600 blur-2xl group-hover:opacity-75 group-hover:-inset-1 group-hover:duration-200 animate-tilt"></div>
      ...
      <img
        ...
        alt=""
        className="min-h-[300px] min-w-[1150px] w-full absolute -bottom-8 left-0 unselectable"
      />
    </div>
  );
}
